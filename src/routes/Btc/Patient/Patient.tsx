      ...
      <S.PatientContainer>
        <S.ChoicesContainerOuter>
          <S.ChoicesContainerInner>
            <h1>Les besoins uniques de vos patients</h1>
              ...
              {rowGroups.row1.map((key) => (
                <S.ImgWrapper key={key} onClick={() => toggleImage(key, 0)}>
                  <img
                    src={
                      activeImages[key]
                        ? imageSources[key].active
                        : imageSources[key].normal
                    }
            ...
            <S.Row2>
              <S.ImgWrapper2 onPointerDown={() => toggleImage("motivated", 1)}>
                <img
                  src={
                    activeImages.motivated
                      ? imageSources.motivated.active
                      : imageSources.motivated.normal
                  }
                />
              </S.ImgWrapper2>
              <S.ImgWrapper3
              ...
              >
                <img
                  src={
                    activeImages.unmotivated
                      ? imageSources.unmotivated.active
                      : imageSources.unmotivated.normal
                  }
                />
              </S.ImgWrapper3>
            </S.Row2>
            ...
            <S.Row>
              {rowGroups.row3.map((key) => (
                <S.ImgWrapper key={key} onClick={() => toggleImage(key, 2)}>
                  <img
                    src={
                      activeImages[key]
                        ? imageSources[key].active
          ...
          <S.GumInterproximalSolution
            $show={showResultButton}
            onClick={handleShowResults}
          >
            <p>
              SOLUTIONS INTERDENTAIRES DE GUM<sup>MD</sup>
            </p>
          </S.GumInterproximalSolution>
        </S.ChoicesContainerOuter>
